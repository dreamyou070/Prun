...
def get_predicted_original_sample(model_output, timesteps, sample, prediction_type, alphas, sigmas):
    ...
    alphas = extract_into_tensor(alphas, timesteps, sample.shape).to(device, dtype=model_output.dtype)
    
    sigmas = extract_into_tensor(sigmas, timesteps, sample.shape).to(device, dtype=model_output.dtype)
    ...
    if prediction_type == "epsilon":
        pred_x_0 = (sample - sigmas * model_output) / alphas # latent space

        #
        # pred_x_0 -> it should be x_0
