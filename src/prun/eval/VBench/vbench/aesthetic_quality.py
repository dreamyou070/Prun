...
def compute_aesthetic_quality(json_dir, device, submodules_list, **kwargs):
    ...
    #  *** submodules_list = ['ViT-L/14', '/home/dreamyou070/.cache/vbench/aesthetic_model/emb_reader']
    # aes_path
    print(f' [1] get aesthetic model, aes_path = {aes_path}')
    if get_rank() == 0:
    ...
    # [2] get clip model
    print(f' [2] get clip model, vit_path = {vit_path}')
