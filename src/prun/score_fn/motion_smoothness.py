...
from prun.third_party.amt.utils.utils import (img2tensor, tensor2img,check_dim_and_resize)
from prun.third_party.amt.utils.build_utils import build_from_cfg
from prun.third_party.amt.utils.utils import InputPadder
...
def compute_motion_smoothness(device, video_list):
