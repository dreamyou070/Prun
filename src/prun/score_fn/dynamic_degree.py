...
from prun.third_party.RAFT.core.raft import RAFT
from prun.third_party.RAFT.core.utils_core.utils import InputPadder
...
def compute_dynamic_degree(device, video_list):
    # [1] make model
