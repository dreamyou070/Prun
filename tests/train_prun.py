...
def main(args):
    ...
    total_layers = ["down_blocks_0_motion_modules_0", "down_blocks_0_motion_modules_1",
    ...
    for layer in total_layers:
        ...
        # zero_state_dict = pruned_unet.state_dict()

        test_pipe.unet = pruned_unet
        ...
        for p, prompt in enumerate(custom_prompts):
            if p < 20:
                evaluation(prompt,
                           ...
                           save_dir,
                           n_prompt, num_frames, guidance_scale,
                           num_inference_steps, h=args.h, weight_dtype=weight_dtype, p=p)
