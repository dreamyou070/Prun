...
target_block_num=10
FOLDER="4_animatelcm_finetune_prun_${target_block_num}_panda_data_LCM_loss_Feture_Matching_step_by_step_test"

accelerate launch \
 --config_file $HOME/gpu_config/gpu_0_config \
 --main_process_port $port_number \
 animatelcm_finetune_block_substitute.py \
 --wandb_run_name "LCM_loss_Feture_Matching" \
